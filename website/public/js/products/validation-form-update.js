window.onload = function () {
  ...
  form.addEventListener("submit", function (e) {
    ...
    if (valueTitle != "" && valueTitle.length <= 5) {
    ...
    if (valueShortDescription.length <= 20) {
    ...
    if (valueLongDescription.length <= 20) {
    ...
    if (Object.keys(errors) === 0) {
      ...
      if (errors.shortDescription) {
        ...
        shortDescription.classList.remove("is-invalid", "is-valid");
      }
      ...
      if (errors.size) {
        ...
        size.classList.remove("is-invalid", "is-valid");
      }
      if (errors.material) {
        ...
        material.classList.remove("is-invalid", "is-valid");
      }
      ...
      if (errors.longDescription) {
        ...
        longDescription.classList.remove("is-invalid", "is-valid");
      }
      if (errors.images) {
